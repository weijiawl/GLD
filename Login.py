        ...
        while True:
            ...
            if int(pos[1]) > 0:
                if int(juese) <= 8:
                    ...
                    #上拉
                    for i in range(3):
                        xamo.MoveTopy(579, 92)
                        time.sleep(0.2)
                        xamo.LeftDoubleClickpy(1)
                        time.sleep(0.5)
                elif int(juese) <= 12:
                    juese_index = 5
                    # 上拉
                ...
                print('角色数 = ' + juese)
                #点击角色
                xamo.MoveTopy(p_x[int(juese) - juese_index], p_y[int(juese) - juese_index])
                time.sleep(0.5)
                xamo.LeftDoubleClickpy(1)
                time.sleep(0.5)
                #点击开始
                xamo.MoveTopy(402, 548)
                time.sleep(0.2)
                xamo.LeftDoubleClickpy(1)
                time.sleep(5)
...
def zhongduan_cha():
    ...
    if int(pos[1]) > 0:
        ...
        intx = int(pos[1])
        inty = int(pos[2])
        xamo.MoveTopy(intx + 37, inty - 29)
        time.sleep(1)
        xamo.LeftDownpy()
        time.sleep(1)
        xamo.MoveTopy(406, 48)
        time.sleep(1)
        xamo.LeftUppy()
        time.sleep(1)
        ...
        if int(pos[1]) > 0:
            ...
            if int(pos[1]) > 0:
                ...
                time.sleep(60)
                return 1
            FinStr = damo.FindStrEpy(234, 243, 562, 335, "制裁15天", "ffffff-000000", 1)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                d1 = datetime.datetime.now()
                # 也可以用days加天数,seconds加秒
    ...
    try:
        ...
        while True:
            ...
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
                xamo.MoveTopy(intx + 23, inty + 76)
                time.sleep(2)
                xamo.LeftDoubleClickpy(1)
                time.sleep(2)
                xamo.MoveTopy(intx + 23 + 60, inty + 76 + 55)
                time.sleep(2)
                xamo.LeftDoubleClickpy(1)
                time.sleep(2)
            ...
            if int(pos[1]) > 0:
                ...
                intya = int(pos[2])
                #点击出售
                xamo.MoveTopy(intxa + 10, intya + 3)
                time.sleep(2)
                xamo.LeftClickpy(1)
                time.sleep(2)
                #点击材料
                xamo.MoveTopy(590, 246)
                time.sleep(2)
                xamo.LeftDoubleClickpy(1)
                time.sleep(2)
                #鼠标移开
    ...
    try:
        ...
        while True:
            ...
            if int(pos[1]) > 0:
                ...
                inty = int(pos[2])
                if kuaqu == "":
                    xamo.MoveTopy(intx + 72, inty + 60)
                    time.sleep(1)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                    #大区确认
                    xamo.MoveTopy(400, 340)
                    time.sleep(1)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                    break
                    ...
                    while True:
                        ...
                        if int(pos[1]) > 0:
                            ...
                            inty = int(pos[2])
                            #选择跨区
                            xamo.MoveTopy(intx + 5, inty + 3)
                            time.sleep(1)
                            xamo.LeftClickpy(1)
                            time.sleep(3)
                            #确认
                            xamo.MoveTopy(397, 326)
                            time.sleep(1)
                            xamo.LeftClickpy(1)
                            time.sleep(3)
                            # 大区确认
        ...
        wuse_is = True
        while True:
            FinStr = damo.FindPicEpy(472, 256, 767, 436, "魔刹石.bmp|挑战书.bmp|无尽的永恒.bmp|数据芯片.bmp|迷幻晶石.bmp|强烈之痕迹.bmp|矛盾的结晶体.bmp|浓缩的异界精髓.bmp", "000000", "0.9", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
                xamo.MoveTopy(intx + 3, inty + 5)
                time.sleep(1)
                xamo.LeftClickpy(1)
                time.sleep(1)
                xamo.LeftClickpy(1)
                ...
                break
            if wuse_is:
                FinStr = damo.FindPicEpy(472, 256, 767, 436, "无色小晶体.bmp", "000000", "0.9", 0)
                pos = FinStr.split('|')
                if int(pos[1]) > 0:
                    intx = int(pos[1])
                    inty = int(pos[2])
                    ...
                    time.sleep(1)
                    if int(pos[0]) == 0:
                        ws_sl = damo.Ocrpy(627, 313, 742, 396, "ffe3ab-000000", 1)
                        ws_sl = re.sub("\D", "", ws_sl)
                        xamo.KeyPressStrpy(str(int(ws_sl)-100))
                        time.sleep(0.5)
                        xamo.KeyPresspy(13,1)
                        time.sleep(1)
                    else:
                        xamo.LeftClickpy(1)
                        time.sleep(1)
        ...
        while True:
            ...
            if time_temp > 3:
                ...
                return 3
        #输入金币
        xamo.MoveTopy(333, 412)
        time.sleep(1)
        xamo.LeftClickpy(1)
        time.sleep(3)
        xamo.KeyPressStrpy(str(int(number) - 300000))
        time.sleep(1)
        #发送
        xamo.MoveTopy(261, 461)
        time.sleep(1)
        xamo.LeftClickpy(1)
        time.sleep(1)
        xamo.MoveTopy(261 - 60, 461)
        xamo.LeftClickpy(1)
        time.sleep(3)
        while True:
            ...
            if int(pos[1]) > 0:
                ...
                for n in range(6):
                    ...
                    time.sleep(0.5)
                time.sleep(1)
                xamo.KeyPressStrpy(xy)
                time.sleep(1)
                xamo.MoveTopy(intx -123, inty + 131)
                time.sleep(1)
                xamo.LeftClickpy(1)
                time.sleep(1)
                xamo.LeftClickpy(1)
                ...
                if int(pos[1]) > 0:
                    ...
                    xamo.MoveTopy(410, 176)
                    time.sleep(1)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                    xamo.MoveTopy(400, 339)
                    time.sleep(1)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                    xamo.MoveTopy(262, 462)
                    time.sleep(1)
                    xamo.LeftClickpy(1)
                    time.sleep(4)
            time.sleep(1)
...
def login(CRuser,CRpwd,path,WeGame,money_is):
    ...
    try:
        while True:
            time.sleep(0.5)
            FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_登录.bmp|tgp_登录1.bmp", "000000", "0.9", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
                #刷新列表
                shuaxinliebiao()
                xamo.MoveTopy(intx + 70, inty - 136)
                time.sleep(0.2)
                xamo.LeftClickpy(1)
                time.sleep(0.5)
                for i in range(13):
                ...
                time.sleep(0.5)
                #输入账号
                xamo.KeyPressStrpy(hao)
                time.sleep(0.5)
                xamo.MoveTopy(intx + 70, inty - 106)
                time.sleep(0.2)
                xamo.LeftClickpy(1)
                time.sleep(0.5)
                #输入密码
                xamo.KeyPressStrpy(mi)
                time.sleep(0.5)
                #点击登录
                xamo.MoveTopy(intx, inty)
                time.sleep(0.2)
                xamo.LeftClickpy(1)
                time.sleep(2)
            ...
            if int(pos[1]) > 0:
                ...
                for i in range(int(xy.split(',')[0]) - 38):
                    xamo.MoveTopy(px + i, py - i)
                    time.sleep(0.005)
                    xamo.LeftUppy()
                time.sleep(5)
                #确认后延迟大点
            FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_跳过.bmp", "000000", "1", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
            ...
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
                xamo.MoveTopy(intx + 403, inty + 8)
                time.sleep(0.2)
                xamo.LeftClickpy(1)
                time.sleep(1)
            FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_主页.bmp", "000000", "1", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
                ...
                xamo.LeftClickpy(1)
                time.sleep(1)
            FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_开始游戏.bmp", "000000", "1", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                print('开始游戏')
                intxa = int(pos[1])
                ...
                pos = FinStr.split('|')
                if int(pos[1]) > 0:
                    xamo.MoveTopy(intxa + 20, intya + 10)
                    time.sleep(0.2)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                    shubiaodianji = True
                else:
                    xamo.MoveTopy(intxa - 116, intya + 10)
                    time.sleep(0.2)
                    xamo.LeftClickpy(1)
                    time.sleep(2)
                ...
                FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_列表_dnf.bmp|tgp_列表_dnf1.bmp", "000000", "1", 0)
                pos = FinStr.split('|')
                if int(pos[1]) > 0:
                    intx = int(pos[1])
                    inty = int(pos[2])
            ...
            if int(pos[1]) > 0:
                ...
                xamo.LeftClickpy(1)
                time.sleep(1)
            FinStr = damo.FindPicEpy(0, 0, x, y, "tgp_登录失败.bmp", "000000", "1", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                return 0
            ...
            if int(pos[1]) > 0:
                return 0
            FinStr = damo.FindStrEpy(0, 0, x, y, "结束游戏", "ddc593-000000|ffffb8-000000", 0.9)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                print('角色界面')
                # hwnda = damo.FindWindowpy("", "打印机")
                # if hwnda > 0:
            ...
            if shubiaodianji:
                ...
                time.sleep(1)
            login_time_now = datetime.datetime.now()
            print('运行中' + login_time_now.strftime('%Y-%m-%d %H:%M:%S'))
            time_temp = login_time_now.minute - login_time.minute
            if time_temp > 6:
                return 3
    except:
    ...
    while True:
        ...
        if int(pos[1]) > 0:
            ...
            if int(pos[1]) > 0:
                ...
                time.sleep(2)
                #选择领取奖励的佣兵
                xamo.MoveTopy(365, 197)
                time.sleep(1)
                xamo.LeftClickpy(1)
                time.sleep(2)
                #确认
                xamo.MoveTopy(363, 319)
                time.sleep(1)
                xamo.LeftClickpy(1)
                time.sleep(2)
                qingkongyouxichuangkou()
...
def liudiangengxin():
    try:
        ...
        prints('六点更新失败')
def saotubiao():
    xamo.MoveTopy(689, 945)
    xamo.MoveTopy(1266, 945)
def chushoudianquan():
    prints('兑换点券')
    int_quan = 0
    while True:
        FinStr = damo.FindStrEpy(578, 401, 784, 560, "整理", "ddc593-000000", 1)
        pos = FinStr.split('|')
        if int(pos[1]) > 0:
            intx = int(pos[1])
            inty = int(pos[2])
        ...
        if int(pos[1]) > 0:
            ...
            if int(pos[1]) > 0:
                ...
                for i in range(10):
                    ...
                    if int(pos[1]) > 0:
                        #购买
                        xamo.MoveTopy(570, 290)
                        time.sleep(0.5)
                        xamo.LeftClickpy(1)
                        time.sleep(0.5)
                        xamo.MoveTopy(570+55, 290+12)
                        time.sleep(0.5)
                        xamo.LeftClickpy(1)
                        time.sleep(0.5)
                        xamo.MoveTopy(570+55+57, 290+12+23)
                        time.sleep(0.5)
                        xamo.LeftClickpy(1)
                        time.sleep(6)
                        aq_ret = 安全模式()
                ...
                xamo.MoveTopy(37, 136)
                time.sleep(1)
                xamo.LeftClickpy(1)
                time.sleep(1)
        else:
            xamo.MoveTopy(386, 576)
            time.sleep(1)
            xamo.LeftClickpy(1)
            time.sleep(1)
            xamo.MoveTopy(367, 538)
            time.sleep(1)
            xamo.LeftClickpy(1)
            time.sleep(1)
def jieshouyoujian():
...
def jinqizhicai():
    ...
    return 0
def 向左():
    if xamo.GetKeyStatepy(38) == 1:
        xamo.KeyUppy(38)
    if xamo.GetKeyStatepy(39) == 1:
        xamo.KeyUppy(39)
    if xamo.GetKeyStatepy(40) == 1:
        xamo.KeyUppy(40)
    if xamo.GetKeyStatepy(37) == 0:
        xamo.KeyPresspy(37,1)
        time.sleep(0.05)
        xamo.KeyDownpy(37)
def 向右():
    if xamo.GetKeyStatepy(38) == 1:
        xamo.KeyUppy(38)
    if xamo.GetKeyStatepy(37) == 1:
        xamo.KeyUppy(37)
    if xamo.GetKeyStatepy(40) == 1:
        xamo.KeyUppy(40)
    if xamo.GetKeyStatepy(39) == 0:
        xamo.KeyPresspy(39,1)
        time.sleep(0.05)
        xamo.KeyDownpy(39)
def 向上():
    if xamo.GetKeyStatepy(40) == 1:
        ...
        if d3.seconds > 20:
            if xamo.GetKeyStatepy(37) == 1:
                ...
                if Rnd == 1:
                    ...
                    弹起()
                break
        FinStr = damo.FindPicEpy(0,78,799,552,"捡.bmp|捡1.bmp","000000","0.95",0)
        pos = FinStr.split('|')
        if int(pos[1]) > 0:
            弹起()
            time.sleep(0.1)
            xamo.KeyPresspy(88,1)
            time.sleep(0.5)
        else:
            FinStr = damo.FindPicEpy(0, 78, 799, 552, "my.bmp", "000000", "1", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                my_x = int(pos[1])
                my_y = int(pos[2])
                ...
                if Rnd == 1:
                    ...
                    time.sleep(0.5)
                    弹起()
            FinStr = damo.FindPicEpy(0,78,799,552,"wp.bmp","000000","1",1)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                wp_x = int(pos[1])
                wp_y = int(pos[2])
...
def 出售分解(ZZ):
    ...
    if int(pos[1]) > 0:
        intx = int(pos[1])
        inty = int(pos[2])
        xamo.MoveTopy(intx, inty + 10)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(1)
        xamo.MoveTopy(intx + 58, inty + 34 + 10)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(3)
        FinStr = damo.FindStrEpy(578, 401, 784, 560, "整理", "ddc593-000000", 1)
        ...
        if int(pos[1]) > 0:
            #装备需要修理自动弹出
            FinStr = damo.FindStrEpy(396, 218, 465, 352, "取消", "ddc593-000000", 1)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                intx = int(pos[1])
                inty = int(pos[2])
            ...
            time.sleep(1)
            #点击装备栏
            xamo.MoveTopy(497, 245)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            #点击整理
            xamo.MoveTopy(685, 485)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            #出售
            xamo.MoveTopy(181, 522)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            y = 262
            ...
            if int(pos[1]) > 0:
                ...
                # 点击消耗栏
                xamo.MoveTopy(543, 245)
                time.sleep(0.2)
                xamo.LeftClickpy(1)
                time.sleep(0.5)
                xamo.MoveTopy(586, 182)
                time.sleep(0.5)
        ...
        if xgis == '真':
            ...
            if xaoguo_return == True:
                ...
                while True:
                    ...
                    pos = FinStr.split('|')
                    if int(pos[1]) > 0:
                        xamo.MoveTopy(400, 307)
                        time.sleep(0.2)
                        xamo.LeftClickpy(1)
                        time.sleep(1)
                        xamo.MoveTopy(442, 332)
                        time.sleep(0.2)
                        xamo.LeftClickpy(1)
                        time.sleep(1)
                        break
...
def 移动():
    ...
    while True:
        ...
        if index == 0:
            ...
            左上()
            FinStr = damo.FindPicEpy(0, 16, 521, 234, "地图中转.bmp", "000000", "0.9", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                弹起()
                index = 2.3
...
def 点击技能(x, y, x1, y1,is_tuodong):
    ...
    if is_tuodong == True:
    #拖动技能
        xamo.MoveTopy(x + 3, y + 3)
        time.sleep(0.5)
        xamo.LeftDownpy()
        time.sleep(0.5)
        xamo.MoveTopy(x + 5, y + 5)
        time.sleep(0.5)
        xamo.MoveTopy(x1, y1)
        time.sleep(0.5)
        xamo.MoveTopy(x1+3, y1+3)
        time.sleep(0.5)
        xamo.LeftUppy()
        time.sleep(0.5)
def 学习技能():
        ...
        if is_wz == False:
            while True:
                ...
                if int(pos[1]) > 0:
                    ...
                    time.sleep(1)
                    #学习
                    xamo.MoveTopy(209, 553)
                    time.sleep(0.5)
                    xamo.LeftClickpy(1)
                    time.sleep(0.5)
                    #确认
                    xamo.MoveTopy(361, 318)
                    time.sleep(0.5)
                    xamo.LeftClickpy(1)
                    time.sleep(0.5)
                    清理游戏窗口()
                    ...
                    xamo.KeyPresspy(75,1)
                    time.sleep(1)
def 检查负重():
    for i in range(10):
        FinStr = damo.FindStrEpy(430, 366, 588, 586, "重量", "e6c89b-000000", 1)
        pos = FinStr.split('|')
        if int(pos[1]) > 0:
            time.sleep(0.5)
            intx = int(pos[1])
            inty = int(pos[2])
            color = damo.GetColorpy(intx + 95, inty + 8)
            prints(color)
            if color == 'd62929':
                return 1
            elif color == '202020':
        ...
        if hwnd > 0:
            ...
            while True:
                ...
                if int(pos[1]) > 0:
                    ...
                    time.sleep(1)
                    qingkongyouxichuangkou()
                FinStr = damo.FindPicEpy(114, 59, 739, 306, "叉.bmp", "000000", "0.9", 0)
                pos = FinStr.split('|')
                if int(pos[1]) > 0:
                    if jinqizhicai() == 1:
                        Imok = False
                ...
                while True:
                    ...
                    if int(pos[1]) > 0:
                        ...
                        if int(pos[1]) > 0:
                            intx = int(pos[1])
                            inty = int(pos[2])
                            xamo.MoveTopy(intx + 3, inty + 3)
                            time.sleep(0.2)
                            xamo.LeftClickpy(1)
                            time.sleep(1)
                            xamo.MoveTopy(426, 403)
                            time.sleep(0.2)
                            xamo.LeftClickpy(1)
                            time.sleep(5)
                            清理游戏窗口()
                ...
                while True:
                    ...
                    if xingwei:
                        ...
                        if guanqia == 1:
                            ...
                            xamo.KeyPresspy(65,1)
                            time.sleep(0.8)
                            xamo.KeyPresspy(89,1)
                            time.sleep(1)
                            FinStr = damo.FindPicEpy(14, 129, 124, 181, "DPS.bmp", "000000", "0.9", 0)
                            pos = FinStr.split('|')
                            if int(pos[1]) > 0:
                                myX = int(pos[1])
                                myY = int(pos[2]) + 10
                                xamo.MoveTopy(myX + 5, myY + 5)
                                time.sleep(0.2)
                                xamo.LeftDownpy()
                                time.sleep(0.5)
                                for i in range(myY - 20):
                                    xamo.MoveTopy(myX + 5, myY - i)
                                    time.sleep(0.005)
                                time.sleep(0.5)
                                xamo.LeftUppy()
                                time.sleep(0.5)
