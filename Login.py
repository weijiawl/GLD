...
#tk_wins.start()
# 盾
dwreg = damo.DmGuardpy(1,'f2 c:\windows\system32\calc.exe ' + os.getcwd() + '\Login.exe')
if dwreg != 1:
    print("驱动盾失败")
    input()
...
jn_sf_time = {'弗利特': 1200, '桑德尔': 1300, '牛头王': 1700, '路易斯': 1500, '伊伽贝拉': 1500, '召唤兽狂化': 1100, '鞭子': 300,'赫德尔': 1200, '冰': 1200, '火': 1200, '光': 1200, '暗': 1200}
            ...
            if wuse_is:
                ...
                if int(pos[1]) > 0:
                    ...
                    if int(pos[0]) == 0:
                        ...
                        damo.KeyPressStrpy(str(int(ws_sl)-100),50)
                        time.sleep(0.5)
                        damo.KeyPresspy(13)
                        time.sleep(1)
                    else:
...
def 出售分解(ZZ):
    ...
    if int(pos[1]) > 0:
        intx = int(pos[1])
        inty = int(pos[2])
        damo.MoveTopy(intx, inty + 10)
        time.sleep(0.2)
        damo.LeftClickpy()
        time.sleep(1)
        damo.MoveTopy(intx + 58, inty + 34 + 10)
        time.sleep(0.2)
        damo.LeftClickpy()
        time.sleep(3)
        FinStr = damo.FindStrEpy(578, 401, 784, 560, "整理", "ddc593-000000", 1)
...
def 点击技能(x, y, x1, y1,is_tuodong):
    ...
    #拖动技能
        ...
        damo.LeftDownpy()
        time.sleep(0.5)
        damo.MoveTopy(x + 5, y + 5)
        time.sleep(0.5)
        damo.MoveTopy(x1, y1)
        time.sleep(0.5)
        damo.MoveTopy(x1+3, y1+3)
        time.sleep(0.5)
        damo.LeftUppy()
        time.sleep(0.5)
def 学习技能():
                ...
                while True:
                    ...
                    if int(pos[1]) > 0:
                        ...
                        if int(pos[1]) > 0:
                            intx = int(pos[1])
                            inty = int(pos[2])
                            damo.MoveTopy(intx + 3, inty + 3)
                            time.sleep(0.2)
                            damo.LeftClickpy()
                            time.sleep(1)
                            damo.MoveTopy(426, 403)
                            time.sleep(0.2)
                            damo.LeftClickpy()
                            time.sleep(5)
                            清理游戏窗口()
                    ...
                    if xingwei:
                        ...
                        if guanqia == 1:
                            ...
                            if int(pos[1]) > 0:
                                myX = int(pos[1])
                                myY = int(pos[2]) + 10
                                damo.MoveTopy(myX + 5, myY + 5)
                                time.sleep(0.2)
                                damo.LeftDownpy()
                                time.sleep(0.5)
                                for i in range(myY - 20):
                                    damo.MoveTopy(myX + 5, myY - i)
                                    time.sleep(0.005)
                                time.sleep(0.5)
                                damo.LeftUppy()
                                time.sleep(0.5)
