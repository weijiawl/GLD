    ...
    try:
        ...
        while True:
            ...
            if int(pos[1]) > 0:
                ...
                #         dw.MoveTopy(p_x[int(juese) - juese_index], p_y[int(juese) - juese_index])
    ...
    try:
        ...
        while True:
            ...
            if int(pos[1]) > 0:
                ...
                xamo.LeftDownpy()
                time.sleep(1)
                xamo.MoveTopy(px + int(xy.split(',')[0]) - 38, py)
                time.sleep(1)
                xamo.LeftUppy()
    ...
    while True:
        ...
        if p == 0:
            ...
            if int(pos[1]) > 0:
                ...
                break
                # if guanqia == 6:
                #     FinStr = dw.uEKuRfCL(604,21,799,162, "my_小地图.bmp", "000000", "0.9", 0)
                #     pos = FinStr.split('|')
                #     if int(pos[1]) > 0:
                #         pass
                #     else:
...
def 打石头():
    ...
    while True:
        ...
        if my_x > 0 and my_y > 0 and wp_x > 0 and wp_y > 0:
            ...
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                FinStr = dw.uEKuRfCL(530, 561, 562, 593, "鞭子.bmp", "000000", "0.9", 0)
                pos = FinStr.split('|')
                if int(pos[1]) > 0:
...
def 出售分解(ZZ):
    ...
    if int(pos[1]) > 0:
        intx = int(pos[1])
        inty = int(pos[2])
        xamo.MoveTopy(intx, inty + 30)
        time.sleep(1)
        xamo.LeftClickpy(1)
        time.sleep(2)
        xamo.MoveTopy(intx + 58, inty + 34 + 30)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(3)
        FinStr = dw.RsJCdWDvHA(578, 401, 784, 560, "整理", "ddc593-000000", 1)
    ...
    if int(pos[1]) > 0:
        ...
        xamo.LeftClickpy(1)
        time.sleep(1)
        xamo.MoveTopy(intx + 58, inty + 55 + 30)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(3)
        FinStr = dw.RsJCdWDvHA(578, 401, 784, 560, "整理", "ddc593-000000", 1)
...
def 学习技能():
    ...
    for t in range(3):
        ...
        #检查技能摆放
        for i in range(12):
            FinStr = dw.uEKuRfCL(326, 529, 714, 592, "召唤技能" + str(i + 1) + ".bmp", "000000", "0.9", 0)
            pos = FinStr.split('|')
            if int(pos[1]) > 0:
                pass
            else:
...
def 检查累积在线奖励():
    ...
    if int(pos[1]) > 0:
        intx = int(pos[1])
        inty = int(pos[2])
        xamo.MoveTopy(intx + 23, inty + 78)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(0.5)
        xamo.MoveTopy(intx + 74, inty + 78)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(0.5)
        xamo.MoveTopy(intx + 126, inty + 78)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(0.5)
        xamo.MoveTopy(intx + 179, inty + 78)
        time.sleep(0.2)
        xamo.LeftClickpy(1)
        time.sleep(0.5)
def 购买物品(name,num):
...
def 购买免修():
    ...
    while True:
        ...
        if int(pos[1]) > 0:
            ...
            for tn in range(3):
                ...
                if int(pos[1]) > 0:
                    intx = int(pos[1])
                    inty = int(pos[2])
                    xamo.MoveTopy(intx + 34, inty + 76)
                    time.sleep(0.2)
                    xamo.LeftClickpy(1)
                    time.sleep(1)
                else:
                    xamo.MoveTopy(403, 98)
                    time.sleep(0.2)
                    xamo.LeftClickpy(1)
                    time.sleep(1)
        else:
            #点击道具类
            xamo.MoveTopy(414, 23)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
        ...
        if int(pos[1]) > 0:
            #点击下拉
            xamo.MoveTopy(428, 201)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            #选择30天
            xamo.MoveTopy(384, 235)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            #购买
            xamo.MoveTopy(503, 476)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(2)
            xamo.KeyPresspy(13,1)
...
def 设置():
    ...
    while True:
        ...
        if d3.seconds > 100:
            弹起()
            return 0
        FinStr = dw.RsJCdWDvHA(163, 421, 260, 478, "快捷键设置", "ddcc99-000000", 1)
        pos = FinStr.split('|')
        if int(pos[1]) > 0:
            intx = int(pos[1])
            inty = int(pos[2])
        ...
        if int(pos[1]) > 0:
            ...
            time.sleep(1)
            #点击输入框
            xamo.MoveTopy(189, 362)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            xamo.KeyPresspy(8,10)
            hwnd = dw.bcGT("地下城与勇士", "地下城与勇士")
            if hwnd > 0:
                dw.gshNarIzNfhm(hwnd, '//移动物品')
            #点击输入框
            xamo.MoveTopy(327, 362)
            time.sleep(0.2)
            xamo.LeftClickpy(1)
            time.sleep(1)
            xamo.KeyPresspy(86, 1)
            #点击保存
            xamo.MoveTopy(569, 513)
            time.sleep(0.2)
            xamo.LeftClickpy(3)
            time.sleep(1)
            清理游戏窗口()
                ...
                while True:
                    ...
                    if int(pos[1]) > 0:
                        ...
                        while True:
                            ...
                            if int(pos[1]) > 0:
                                弹起()
                                FinStr = dw.uEKuRfCL(510, 366, 536, 395, "副本界面_格兰迪.bmp", "000000", "0.9", 0)
                                pos = FinStr.split('|')
                                if int(pos[1]) > 0:
                                    for i in range(5):
                                        xamo.KeyPresspy(37,1)
...
def while_():
    ...
    x = dw.yTKUBaTqevaYZRU()
    y = dw.vgtwHdrCtErzwk()
    jianqu = get_ini('config/cfg.ini', '游戏配置', '捡取')
            ...
            while True:
                ...
                if int(pos[1]) > 0:
                    ...
                    if is_60m == True:
                        ...
                        prints("等待60秒...")
                        #设置
                        shezhi = get_ini('config/设置.ini', '设置', account.hao + '_' + account.daqu)
                        if shezhi != '真':
                            sz_ret = 设置()
                            if sz_ret == 1:
            ...
            while True:
                ...
                while True:
                    ...
                    if int(pos[1]) > 0:
                        myX = int(pos[1])
                        myY = int(pos[2])
                        FinStr = dw.AIdCpitUAXsF(myX - 100, myY + 130, myX + 120, myY + 210,
                    ...
                    # FinStr = dw.uEKuRfCL(0, 0, x, y, "tgp_列表_dnf.bmp|tgp_列表_dnf1.bmp", "000000", "0.9", 0)
                    # pos = FinStr.split('|')
                    # if int(pos[1]) > 0:
                    #     prints("游戏窗口消失")
                    #     end_exsit(2)
